<footer class="w-full px-4 py-10 mx-auto sm:px-6 lg:px-8 bg-slate-800 dark:bg-slate-950">
    ...
    <div class="grid justify-between grid-cols-1 gap-10 m-2 mx-auto mt-10 text-white md:grid-cols-2">
        <div class="text-center md:max-w-[75%] text-sm md:text-base">
            <p>Perusahaan kami adalah Dealer Resmi PT. DAIKIN AIRCONDITIONING INDONESIA untuk Penjualan AC dan Sparepart. Kami juga menyediakan Jasa Pemasangan dan Pemeliharaan AC dengan harga terbaik.</p>
        </div>
        <div class="text-sm text-center md:text-base">
            <p>Jl. Lembah Damai No. 35 Kel. Lembah Damai,<br>Kec. Rumbai Pesisir, Kota Pekanbaru, Riau 28263 <br>Telepon: +62-822-6886-4800</p>
        </div>
    </div>

    <div class="text-center">
        <div class="mt-3">
            <p class="text-gray-500">Bagian dari <a class="font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400" target="_blank" href="https://www.daikin.co.id/">PT. Daikin Airconditioning Indonesia.</a></p>
            <p class="text-gray-500">© 2024 PT. Mellisa Lestari Sinergi. Hak cipta dilindungi undang-undang.</p>
        </div>
